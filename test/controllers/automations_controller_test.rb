...
class AutomationsControllerTest < ActionController::TestCase
  ...
  test "should create automation" do
    assert_difference('Automation.count') do
      post :create, automation: { description: @automation.description, json: @automation.json, name: @automation.name, package_id: @automation.package_id, tags: @automation.tags }
    end
  ...
  test "should update automation" do
    patch :update, id: @automation, automation: { description: @automation.description, json: @automation.json, name: @automation.name, package_id: @automation.package_id, tags: @automation.tags }
    assert_redirected_to automation_path(assigns(:automation))
  end
